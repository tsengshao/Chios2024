...
# Time settings
dt_euler = 0.00001  # Chosen time step for Euler method (small for stability)
dt_rk4 = 0.00001  # Larger time step for RK4 due to its accuracy
dt_sci = 0.00001  # Larger time step for RK4 due to its accuracy
t_max = 40
num_steps_euler = int(t_max / dt_euler)
num_steps_rk4 = int(t_max / dt_rk4)
num_steps_sci = int(t_max / dt_sci)
# Time arrays
time_euler = np.linspace(0, t_max, num_steps_euler)
time_rk4 = np.linspace(0, t_max, num_steps_rk4)
time_sci = np.linspace(0, t_max, num_steps_sci)
...
states_sci = result_sci.y.T
time_sci   = result_sci.t
